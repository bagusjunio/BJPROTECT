...
module.exports = {
    name: "remove",
    description: "Menghapus user dari daftar trusted",
...
if(message.author.id === message.guild.ownerID) {
     ...
     message.channel.send(`Dia emang ga ada di trusted list`)
        }}
    
      message.channel.send(`Cuman owner doang yang bisa setting!`)
}}
